...
*Hierarquia de dados*: toda inserção de informações deve obedecer rigorosamente à estrutura de dependência, na qual um Compromisso precede um Objetivo, este precede uma Linha de Ação, que por sua vez precede uma Tarefa, que culmina em um ou mais Indicadores.
